...
def get_args():
    ...
    parser.add_argument("--task", type=str, default="Obstacle2D-v0")
    parser.add_argument("--logdir", type=str, default="log/Obstacle2D")
    ...
    parser.add_argument("--action-scaling", type=bool, default=False)
