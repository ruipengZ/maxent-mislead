...
def get_args():
    ...
    parser.add_argument("--sigma-param", type=float, default=-0.5)
    parser.add_argument("--logdir", type=str, default="log/OpenCat")
    parser.add_argument("--conditioned-sigma", type=bool, default=False)
    parser.add_argument("--algo-name", type=str, default="ppo")
    parser.add_argument("--task", type=str, default="OpenCat-v0")
    ...
    parser.add_argument("--obs-norm", type=bool, default=True)
