...
def get_args():
    ...
    parser.add_argument("--logdir", type=str, default="log/Acrobot")
    parser.add_argument("--algo-name", type=str, default="sac-AdaEnt")
    parser.add_argument("--task", type=str, default="Acrobot-v0")

    parser.add_argument("--save-interval", type=int, default=1)
    parser.add_argument("--rew-norm", type=int, default=False)
    parser.add_argument("--entropy-n-sample", type=int, default=100)
    parser.add_argument("--entropy-dist-threshold", type=float, default=0.7)
