...
def get_args():
    ...
    parser.add_argument("--logdir", type=str, default="log/Quadrotor")
    parser.add_argument("--algo-name", type=str, default="sac-AdaEnt")
    parser.add_argument("--task", type=str, default="QuadRotor-v0")
    ...
    parser.add_argument("--entropy-dist-threshold", type=float, default=0.9)
